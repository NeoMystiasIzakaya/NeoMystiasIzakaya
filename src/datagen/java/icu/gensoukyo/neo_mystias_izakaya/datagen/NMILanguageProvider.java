...
public class NMILanguageProvider implements DataProvider {
    ...
    private void addItemTranslations() {
        this.add(NMIIngredientItems.BAMBOO_SHOOTS, "Bamboo Shoots", "竹笋");
        this.add(NMIIngredientItems.BLACK_SALT, "Black Salt", "黑盐");
        this.add(NMIIngredientItems.BLACK_PORK, "Iberico Pork", "黑毛猪肉");
        ...
        this.add(NMIIngredientItems.CAPSAICIN, "Strong Capsaicin", "辣椒素");
        ...
        this.add(NMIIngredientItems.FLOWERS, "Flowers", "鲜花");
        this.add(NMIIngredientItems.FICUS_MICROCARPA, "Creeping Fig", "薜荔");
        this.add(NMIIngredientItems.GINKGO, "Ginkgo", "白果");
        this.add(NMIIngredientItems.GRAPE, "Grape", "葡萄");
        this.add(NMIIngredientItems.HAGFISH, "Hagfish", "八目鳗");
        this.add(NMIIngredientItems.LEMON, "Lemon", "柠檬");
        this.add(NMIIngredientItems.LOTUS_NUTS, "Lotus Nuts", "莲子");
        this.add(NMIIngredientItems.MOONFLOWER, "Lunar Herb", "月光草");
        ...
        this.add(NMIIngredientItems.PUFF_YO_FRUIT, "Jiguru Berry", "噗噗呦果");
        this.add(NMIIngredientItems.RED_BEANS, "Red Beans", "红豆");
        ...
        this.add(NMIIngredientItems.CICADA_SHELL, "Cicada Shell", "蝉蜕");
        this.add(NMIIngredientItems.UDUMBARA, "Udumbara", "幻昙华");
        this.add(NMIIngredientItems.STICKY_RICE, "Sticky Rice", "糯米");
        this.add(NMIIngredientItems.SUPREME_TUNA, "Supreme Tuna", "极上金枪鱼");
        ...
        this.add(NMIIngredientItems.TOON, "Toon", "香椿");
        this.add(NMIIngredientItems.TREMELLA, "Tremella", "银耳");
        ...
        this.add(NMIIngredientItems.TWIN_LOTUS, "Twin Lotus", "并蒂莲");
        this.add(NMIIngredientItems.WAGYU_BEEF, "Wagyu Beef", "和牛");
        this.add(NMIIngredientItems.WHITE_RADISH, "Radish", "萝卜");
        this.add(NMIIngredientItems.WILD_BOAR_MEAT, "Wild Boar Meat", "野猪肉");
        this.add(NMIFoodItems.ALL_MEAT_FEAST, "All Meat Feast", "全肉盛宴");
        this.add(NMIFoodItems.ARCTIC_SWEET_SHRIMP_AND_PEACH_SALAD, "Arctic Sweet Shrimp and Peach Salad", "北极甜虾蜜桃色拉");
        this.add(NMIFoodItems.ASSORTED_TEMPURA, "Assorted Tempura", "什锦天妇罗");
        this.add(NMIFoodItems.A_LITTLE_SWEET_POISON, "A Little Sweet Poison", "小小的甜蜜「毒药」");
        this.add(NMIFoodItems.BAKED_CRAB_WITH_CREAM, "Baked Crab with Cream", "奶油焗蟹");
        this.add(NMIFoodItems.BAKED_SWEET_POTATOES, "Baked Sweet Potatoes", "烤地瓜");
        this.add(NMIFoodItems.BAMBOO_SHOOTS_FRIED_MEAT, "Bamboo Shoots Fried Meat", "竹笋炒肉");
        this.add(NMIFoodItems.BAMBOO_SHOOTS_STEWED_IN_STONE_POT, "Bamboo Shoots Stewed in Stone Pot", "石锅竹笋炖肉");
        this.add(NMIFoodItems.BAMBOO_STEAMED_EGG, "Bamboo Steamed Egg", "竹筒蒸蛋");
        this.add(NMIFoodItems.BAMBOO_TUBE_ROASTED_DRUNKEN_SHRIMP, "Bamboo Tube Roasted Drunken Shrimp", "竹筒烧醉虾");
        this.add(NMIFoodItems.BAMBOO_TUBE_STEAMED_PORK, "Bamboo Tube Steamed Pork", "竹筒粉蒸肉");
        this.add(NMIFoodItems.BEAR_PAW, "Imitation Bear Paw", "赛熊掌");
        this.add(NMIFoodItems.BEEF_HOT_POT, "Beef Hot Pot", "牛肉鸳鸯火锅");
        this.add(NMIFoodItems.BEEF_RICE, "Beef Rice", "牛肉盖浇饭");
        this.add(NMIFoodItems.BEEF_WELLINGTON, "Beef Wellington", "惠灵顿牛排");
        this.add(NMIFoodItems.BEETLE_STEAMED_CAKE, "Beetle Steamed Cake", "兜甲蒸糕");
        this.add(NMIFoodItems.BURNT_PUDDING, "Burnt Pudding", "燃尽布丁");
        this.add(NMIFoodItems.BISCAY_BISCUITS, "Biscay Biscuits", "比斯开湾饼干");
        this.add(NMIFoodItems.BOILED_FISH, "Boiled Fish", "水煮鱼");
        this.add(NMIFoodItems.BRAISED_EEL, "Braised Eel", "红烧鳗鱼");
        this.add(NMIFoodItems.BRAISED_PORK_WITH_PEACH, "Peach Braised Pork", "蜜桃红烧肉");
        this.add(NMIFoodItems.BUTTER_STEAK, "Butter Steak", "黄油牛排");
        this.add(NMIFoodItems.CANDIED_CHESTNUTS, "Honeyed Chestnut", "蜜饯栗子");
        this.add(NMIFoodItems.CANDIED_SWEET_POTATO, "Candied Sweet Potato", "拔丝地瓜");
        this.add(NMIFoodItems.CATS_PLAYING_IN_WATER, "Cats Playing in Water", "猫咪戏水");
        this.add(NMIFoodItems.CAT_FOOD, "Neko-manma", "猫饭");
        this.add(NMIFoodItems.CAT_KULULI, "Kitten Canele", "猫咪可露丽");
        this.add(NMIFoodItems.CAT_PIZZA, "Cat Pizza", "猫咪披萨");
        this.add(NMIFoodItems.CHEESE_EGG, "Cheese Egg", "芝士蛋");
        this.add(NMIFoodItems.COLD_DISH_CARVING, "Cold Dish Carving", "凉菜雕花");
        this.add(NMIFoodItems.COLD_TOFU, "Cold Tofu", "冷豆腐");
        this.add(NMIFoodItems.COLORFUL_JADE_FRIED_BUNS, "Colorful Jade Fried Buns", "华光玉煎包");
        this.add(NMIFoodItems.COOKING_TOFU, "Cooking Tofu", "煮豆腐");
        this.add(NMIFoodItems.CREAM_STEW, "Cream Stew", "奶油炖菜");
        this.add(NMIFoodItems.CRISP_CYCLONE, "Crisp Cyclone", "脆旋风");
        this.add(NMIFoodItems.DARK_CUISINE, "Dark Cuisine", "黑暗物质");
        this.add(NMIFoodItems.DEEP_FRIED_CICADA_SHELLS, "Fried Cicada Sloughs", "香炸蝉蜕");
        this.add(NMIFoodItems.DEPRESSED_CHEESE_STICKS, "Misery Cheese Sticks", "丧气芝士条");
        this.add(NMIFoodItems.DEW_BOILED_EGGS, "Dew Boiled Eggs", "露水煮蛋");
        this.add(NMIFoodItems.DORAYAKI, "Dorayaki", "铜锣烧");
        this.add(NMIFoodItems.DUMPLING, "Dumpling", "水饺");
        this.add(NMIFoodItems.EEL_EGG_DONBURI, "Eel Bowl with Egg", "鳗鱼嫩蛋丼");
        this.add(NMIFoodItems.EGGS_BENEDICT, "Eggs Benedict", "班尼迪克蛋");
        this.add(NMIFoodItems.ENERGY_STRING, "Energy String", "能量串");
        this.add(NMIFoodItems.FAILING_SAKURA_SNOW, "Falling Blossoms", "樱落雪");
        this.add(NMIFoodItems.FANTASY_IS_ALL_THE_RAGE, "Fantasy Is All the Rage", "幻想风靡");
        this.add(NMIFoodItems.FISH_LEAPS_OVER_DRAGON_GATE, "Fish Leaps Over Dragon Gate", "鱼跃龙门");
        this.add(NMIFoodItems.FLOWERS_BIRDS_WIND_AND_MOON, "Flowers Birds Wind and Moon", "花鸟风月");
        this.add(NMIFoodItems.FLOWING_WATER_NOODLES, "Flowing Water Noodles", "流水素面");
        this.add(NMIFoodItems.FRIED_HAGFISH, "Fried Hagfish", "炸八目鳗");
        this.add(NMIFoodItems.FRIED_PORK_CUTLET, "Fried Pork Cutlet", "炸猪肉排");
        this.add(NMIFoodItems.FRIED_PORK_SHREDS, "Fried Pork Shreds", "炒肉丝");
        this.add(NMIFoodItems.FRIED_SHRIMP_TEMPURA, "Fried Shrimp Tempura", "炸虾天妇罗");
        this.add(NMIFoodItems.FRIED_TOFU, "Fried Tofu", "油豆腐");
        this.add(NMIFoodItems.FRIED_TOMATO_STRIPS, "Fried Tomato Strips", "炸番茄条");
        this.add(NMIFoodItems.FRIGHT_ADVENTURE, "Heart-Throbbing Surprise!", "惊吓！大冒险");
        this.add(NMIFoodItems.GAME_SOUP, "Hunter's Casserole", "野味加农");
        this.add(NMIFoodItems.GENSOKYO_BUDDHA_JUMPS_OVER_THE_WALL, "Gensokyo Buddha Jumps Over the Wall", "幻想佛跳墙");
        this.add(NMIFoodItems.GENSOKYO_STAR_LOTUS_SHIP, "Gensokyo Star Lotus Ship", "幻想星莲船");
        this.add(NMIFoodItems.GIANT_TAMAGOYAKI, "Giant Tamagoyaki", "巨人玉子烧");
        this.add(NMIFoodItems.GINKGO_AND_RADISH_PORK_RIB_SOUP, "Ginkgo and Radish Pork Rib Soup", "白果萝卜排骨汤");
        this.add(NMIFoodItems.GLOOMY_FRUIT_PIE, "Gloomy Fruit Pie", "阴郁水果派");
        this.add(NMIFoodItems.GLUTINOUS_RICE_BALLS, "Glutinous Rice Balls", "汤圆");
        this.add(NMIFoodItems.GOLDEN_CRISPY_FISH_CAKE, "Golden Crispy Fish Cakes", "黄金酥鱼饼");
        this.add(NMIFoodItems.GRAND_BANQUET, "Grand Banquet", "大奢宴");
        this.add(NMIFoodItems.GREEN_BAMBOO_WELCOMES_SPRING, "Green Bamboo Welcomes Spring", "翠竹迎春");
        this.add(NMIFoodItems.GREEN_FAIRY_MUSHROOM, "Green Fairy Mushroom", "绿野仙菇");
        this.add(NMIFoodItems.GRILLED_HAGFISH, "Grilled Hagfish", "烤八目鳗");
        this.add(NMIFoodItems.GRILLED_PORK_RICE_BALLS, "Grilled Pork Rice Balls", "炙猪肉饭团");
        this.add(NMIFoodItems.HEART_PORRIDGE_GRUEL, "Heart Porridge Gruel", "养心粥");
        ...
        this.add(NMIFoodItems.LOOKING_UP_AT_THE_CEILING_FRUIT_PIE, "Looking Up at the Ceiling Fruit Pie", "仰望天花板派");
        this.add(NMIFoodItems.LOTUS_FISH_RICE_BOWL, "Lotus Fish Rice Bowl", "荷花鱼米盏");
        this.add(NMIFoodItems.LUOHAN_VEGETARIAN, "Luohan Vegetarian", "罗汉上素");
        this.add(NMIFoodItems.MAD_HATTER_TEA_PARTY, "Mad Hatter Tea Party", "疯帽子茶会");
        this.add(NMIFoodItems.MAGMA, "Magma", "岩浆");
        this.add(NMIFoodItems.MAOYU_LAVA_TOFU, "Cubic Kedama Volcanic Tofu", "毛玉熔岩豆腐");
        this.add(NMIFoodItems.MAOYU_TRICOLOR_ICE_CREAM, "Cubic Kedama Ice Cream", "毛玉三色冰激凌");
        this.add(NMIFoodItems.MAPO_TOFU, "Mapo Tofu", "麻婆豆腐");
        this.add(NMIFoodItems.MILKY_MUSHROOM_SOUP, "Milky Mushroom Soup", "奶香蘑菇汤");
        this.add(NMIFoodItems.MOCHI, "Mochi", "麻薯");
        this.add(NMIFoodItems.MOLECULAR_EGG, "Molecular Egg", "分子蛋");
        this.add(NMIFoodItems.MOONLIGHT_DUMPLINGS, "Moonlight Dumplings", "月光团子");
        this.add(NMIFoodItems.MOONLIGHT_OVER_LOTUS_POND, "Moonlight Over Lotus Pond", "荷塘月色");
        ...
        this.add(NMIFoodItems.ORDINARY_SMALL_CAKE, "Ordinary Small Cake", "普通小蛋糕");
        this.add(NMIFoodItems.PAN_FRIED_MUSHROOM_MEAT_ROLL, "Pan Fried Mushroom Meat Roll", "香煎双菇肉卷");
        this.add(NMIFoodItems.PAN_FRIED_SALMON, "Salmon Steak", "香煎三文鱼");
        this.add(NMIFoodItems.PEACH_BLOSSOM_GLAZE_ROLL, "Peach Blossom Glaze Roll", "桃花琉璃卷");
        this.add(NMIFoodItems.PEACH_BLOSSOM_SOUP, "Peach Blossom Soup", "桃花羹");
        this.add(NMIFoodItems.PHOENIX, "Phoenix", "不死鸟");
        this.add(NMIFoodItems.PICKLED_CUCUMBERS, "Pickled Cucumbers", "腌黄瓜");
        this.add(NMIFoodItems.PIG_DEER_BUTTERFLY, "Pig Deer Butterfly", "猪鹿蝶");
        this.add(NMIFoodItems.PINE_NUT_CAKE, "Pine Nut Cake", "松子糕");
        this.add(NMIFoodItems.PIRATE_BACON, "Pirate Bacon", "海盗熏肉");
        this.add(NMIFoodItems.PLUM_TEA_RICE, "Plum Tea Rice", "梅子茶泡饭");
        this.add(NMIFoodItems.POETRY_AND_GINKGO, "Poetry and Ginkgo", "诗礼银杏");
        this.add(NMIFoodItems.POISONOUS_GARDEN, "Poisonous Garden", "毒瘴花园");
        this.add(NMIFoodItems.PORK_AND_TROUT_SMOKED, "Pork and Trout Smoked", "猪肉鳟鱼熏");
        this.add(NMIFoodItems.PORK_RICE, "Pork Rice", "猪肉盖浇饭");
        this.add(NMIFoodItems.POTATO_CROQUETTES, "Potato Croquettes", "土豆可乐饼");
        this.add(NMIFoodItems.PSEUDO_JIRITAMA, "Pseudo Jiritama", "拟尻子玉");
        this.add(NMIFoodItems.PUMPKIN_SHRIMP_CAKE, "Pumpkin Shrimp Cake", "南瓜虾盅");
        this.add(NMIFoodItems.RAPUNZEL, "Rapunzel", "长发公主");
        ...
        this.add(NMIFoodItems.REFRESHING_PUDDING, "Refreshing Pudding", "提神布丁");
        this.add(NMIFoodItems.REVERSING_THE_WORLD, "Against The World!", "逆转天地！");
        this.add(NMIFoodItems.RICE_BALL, "Rice Ball", "饭团");
        this.add(NMIFoodItems.RISOTTO, "Risotto", "意式烩饭");
        this.add(NMIFoodItems.ROASTED_MUSHROOMS, "Roasted Mushrooms", "烤蘑菇");
        ...
        this.add(NMIFoodItems.SCARLET_DEVILS_CAKE, "Scarlet Devil's Cake", "猩红恶魔蛋糕");
        this.add(NMIFoodItems.SCONES, "Scones", "司康饼");
        this.add(NMIFoodItems.SCREAMING_ODEN, "Screaming Oden", "绝叫关东煮");
        this.add(NMIFoodItems.SEAFOOD_MISO_SOUP, "Seafood Miso Soup", "海鲜味噌汤");
        this.add(NMIFoodItems.SEA_URCHIN_SHINGEN_PANCAKE, "Sea Urchin Shingen Pancake", "海胆信玄饼");
        this.add(NMIFoodItems.SEA_URCHIN_SASHIMI, "Sea Urchin Sashimi", "海胆刺身");
        this.add(NMIFoodItems.SECRET_DRIED_FISH, "Secret Dried Fish", "秘制小鱼干");
        this.add(NMIFoodItems.SECRET_MUSHROOM_CASSEROLE, "Secret Savory Mushroom Hotpot", "秘制鲜菌煲");
        this.add(NMIFoodItems.SEVEN_COLORED_YOKAN, "Seven-Colored Yokan", "七色羊羹");
        this.add(NMIFoodItems.SHIRAGA_SADAMATSU, "Shiraga Sadamatsu", "白鹿贞松");
        this.add(NMIFoodItems.SKINNY_HORSE_DUMPLING, "Skinny Horse Dumpling", "瘦马团子");
        this.add(NMIFoodItems.SNOW_WHITE, "Shirayuki", "白雪");
        this.add(NMIFoodItems.STEAMED_EGG_WITH_SEA_URCHIN, "Steamed Egg with Sea Urchin", "海胆蒸蛋");
        this.add(NMIFoodItems.STINKY_TOFU, "Stinky Tofu", "臭豆腐");
        this.add(NMIFoodItems.STRENGTH_SOUP, "Strength Soup", "力量汤");
        this.add(NMIFoodItems.SUPERME_SEAFOOD_NOODLES, "Supreme Seafood Noodles", "至尊海鲜面");
        this.add(NMIFoodItems.TAICHI_BAGUA_FISH_MAW, "Taichi Bagua Fish Maw", "太极八卦鱼肚");
        this.add(NMIFoodItems.TAKETORIHIME, "Kaguya-hime", "竹取姬");
        this.add(NMIFoodItems.TAKOYAKI, "Takoyaki", "章鱼烧");
        this.add(NMIFoodItems.THE_BEAUTY_OF_HAN_PALACE, "The Beauty of Han Palace", "汉宫藏娇");
        this.add(NMIFoodItems.THE_DREAM, "The Dream", "幽梦");
        this.add(NMIFoodItems.THE_MARS, "Planet Mars", "火星");
        this.add(NMIFoodItems.THE_SOURCE_OF_LIFE, "The Source of Life", "生命之源");
        this.add(NMIFoodItems.TIANSHI_BRAISED_CHESTNUT_MUSHROOMS, "Tianshi Braised Chestnut Mushrooms", "天师板栗焖菇");
        this.add(NMIFoodItems.TOFU_MISO, "Tofu Miso", "豆腐味噌");
        this.add(NMIFoodItems.TOFU_POT, "Tofu Pot", "豆腐锅");
        this.add(NMIFoodItems.TONKOTSU_RAMEN, "Tonkotsu Ramen", "豚骨拉面");
        this.add(NMIFoodItems.TOON_PANCAKES, "Toon Pancakes", "香椿煎饼");
        this.add(NMIFoodItems.TWO_HEAVENS_ONE_STYLE, "Two Heavens One Style", "二天一流");
        this.add(NMIFoodItems.UDUMBARA_CAKE, "Udumbara Cake", "幻昙花糕");
        this.add(NMIFoodItems.UNCONSCIOUS_MONSTER_MOUSSE, "Unconscious Youkai Mousse", "无意识妖怪慕斯");
        this.add(NMIFoodItems.VEGETABLE_SPECIAL, "Vegetable Salad", "蔬菜专辑");
        this.add(NMIFoodItems.WARM_RICE_BALL, "Pink Rice Ball", "温暖饭团");
        this.add(NMIFoodItems.WHITE_PEACH_EIGHT_BRIDGE, "Peach Yatsuhashi", "白桃生八桥");
        this.add(NMIFoodItems.YUNSHAN_COTTON_CANDY, "Yunshan Cotton Candy", "云山棉花糖");
        this.add(NMIFoodItems.ZHAJI, "Hodgepodge", "杂炊");
    ...
    private void addItemDescTranslations(){
        ...
        this.addDescription(NMIFoodItems.A_LITTLE_SWEET_POISON, "A dessert modeled after the little poisonous doll—Medicine Melancholy. Its cute appearance is accompanied by strange colors, not too dissimilar from the charmingly beautiful poisonous mushrooms in nature, tempting people to harvest them. But in actuality, it's not poisonous, just like Medicine~", "这是专门给小小的毒人偶一一梅蒂欣制作的印象甜品。可爱中带着诡异的色彩,犹如自然、界中徇丽的毒蘑菇勾人采摘。实际是没有毒的,梅蒂欣也是~");
        ...
        this.addDescription(NMIFoodItems.ARCTIC_SWEET_SHRIMP_AND_PEACH_SALAD, "A high-class dish made from the freshest shrimp and peaches. Supposedly, they are only served at banquets in the Outside World.", "选用品质最好、肉质最鲜的虾和桃子加工而成的高级料理，据说在外界只有在宴席上才有机会一见。");
        this.addDescription(NMIFoodItems.ASSORTED_TEMPURA, "Who said fried food must be birds? In land, in sea or under the ground, anything can become a crispy, mouth-watering delight once smothered in flour and deep fried. Finish with lunar herbs as garnish to subtly neutralize the greasiness of fried foods.", "谁说炸物就必须得是鸟类呢?地上跑的、土里长的、水里游的都可以裹上面粉放到油锅里炸一炸,出锅皆是香味四溢、酥脆爽口。最后以梦幻的月光草为缀,巧妙地中和了炸物拼盘的油腻。");
        this.addDescription(NMIFoodItems.BAKED_CRAB_WITH_CREAM, "Even before opening the lid, the aroma of the Creamy Crab is already irresistible. However, this is just the beginning. Cracking open a pincer reveals white and juicy flesh that when eaten together with the soup, forms a harmonious combination of delicious flavor.", "奶油焗的螃蟹在没升盖之前就已经香气四溢,然而这香气只是前戏。撕开蟹钳,弹出白嫩饱满的肉质,此时再细细地吸入汤汁,螃蟹固有的鲜味才彻底的融合与释放。");
        this.addDescription(NMIFoodItems.BAKED_SWEET_POTATOES, "A timeless street snack popular everywhere, especially during winter times. Who would be able to resist the sight of a warm stove with this yellow-colored goodness? But don't be greedy, eating too much will upset your stomach.", "无论什么时候都大受欢迎的民间小吃。尤其在寒冷的冬天,看到热气腾腾的烤炉,想到那红皮黄额的颜色、热乎甜软的口感,谁能忍得住呢?但不能贪嘴,吃太多容易导致胃腹不适。");
        this.addDescription(NMIFoodItems.BAMBOO_SHOOTS_FRIED_MEAT, "The simplest way to cook bamboo shoots, with the greasiness of the pork acting as foil for the delicious freshness of the bamboo shoots.", "最朴素的竹笋的吃法，由猪肉的油光引出的竹笋的鲜美。");
        this.addDescription(NMIFoodItems.BAMBOO_SHOOTS_STEWED_IN_STONE_POT, "A home-cooked dish featuring beef and bamboo shoot. Meat stewed with fresh and tender bamboo shoot whets the appetite and improves digestion. Plate it with bamboo and you get a wonderful blend of flavor and color.", "以牛肉、竹笋为主要食材的一道家常菜品。鲜嫩的竹笋炖肉具有开胃、促进消化的作用,再以竹子作为摆盘,可谓是色香味俱全。");
        this.addDescription(NMIFoodItems.BAMBOO_STEAMED_EGG, "A type of egg custard that uses a bamboo barrel as the container, giving the dish a unique taste.", "竹子作为容器蒸出来的茶碗蒸，别有一番风味。");
        this.addDescription(NMIFoodItems.BAMBOO_TUBE_ROASTED_DRUNKEN_SHRIMP, "Freshly-caught shrimp marinated in sake, bathed in ice, and topped with spices. A doubled experience combined with both shrimp's umami and sake's fragrance. Delicious!", "把新鲜的虾放进醇香的酒中浸泡,再冰镇后淋上香料食用。既可以尝到虾的鲜香,同时也可以尝到酒的洌香,十分可口。");
        this.addDescription(NMIFoodItems.BAMBOO_TUBE_STEAMED_PORK, "The most tender parts of pork, cut into sections of bamboo with small holes poked in, filled with ingredients and spice, and steamed under high heat until the unique fragrance of bamboo emerges. If time allows it, adding in water during the marinating process will give the meat a shine and makes it easier to swallow.", "将猪身上最嫩的部位,以新鲜的竹简锯留成节,通小孔,灌上菜料和香料,开大火蒸熟后飘出竹子的独特清香。有时间的条件下,在腌渍肉片的时候加点清水会更加晶莹润口。");
        this.addDescription(NMIFoodItems.BEAR_PAW, "The weirdest dish in Gensokyo! Since I can't defeat a bear, it's not made with real bear paws. But with its unforgettable fragrance and delicious taste, it's a hundred times better than the real thing!", "黑不溜秋的怪异美食之首！香飘万里，让人回味无穷。因为打不过熊，没法直接用熊掌做，但是比真正的熊掌还要鲜美百倍。");
        this.addDescription(NMIFoodItems.BEEF_HOT_POT, "Makai pepper spicy broth on the one side, daikon beef bone broth fills the other, a red-and-white specialty beef hotpot. Divided yet coherent together, smells like family.", "一边是魔界辣椒汤底,一边是萝牛骨汤底,兼具红白两种汤汁的特色双锅牛肉。一家人,一个锅,两种口味团团圆圆,仿佛有它就有家的气息。");
        this.addDescription(NMIFoodItems.BEEF_RICE, "A common family dish. The aromatic sauce drizzled over soft rice blends with the taste of beef. Makes anyone hungry.", "常见的家常菜，看上去颗颗饭粒饱满，淋上的香酱与牛肉的口感融为一体，令人口味倍增。");
        ...
        this.addDescription(NMIFoodItems.BEETLE_STEAMED_CAKE, "Whether on the surface or the Underworld, the kabuto beetle is a sign of strength and supremacy! This is a dish made in its image to celebrate its prowess!", "无论是地上还是地下,兜角甲虫都是力量和无敌的象征!这是懂憬它的力量而诞生的查甲料理!");
        ...
        this.addDescription(NMIFoodItems.BOILED_FISH, "An authentic Chinese Sichuan dish. Fresh fish filet boiled with red chili peppers will result in exploding flavors!", "正宗的四川中华料理。鲜嫩肥美的鱼肉与犹如半天朱霞的辣椒一起翻滚，煮成了一道鱼香四溢，椒味袭人的绝味。");
        this.addDescription(NMIFoodItems.BRAISED_EEL, "One of my signature dishes. A juicy appetizer made by cooking lampreys with special sauces. The smell alone can make you drool.", "本店招牌。将鳗鱼用特殊酱料进行烧制后肉汁四溢，光闻着香味便让人垂涎不已。");
        this.addDescription(NMIFoodItems.BRAISED_PORK_WITH_PEACH, "Soft tender meat on top of aromatic peach, a dish you'll never get sick of even if eaten by itself. Cook with a dash of honey to further enhance the flavor. Pairs exceedingly well with alcohol.", "软糯的肉加上香甜的桃子,即使白嘴吃也不会觉得腻。淋上蜂蜜一起翻炒,更是红润添香,非常适合下酒。");
        this.addDescription(NMIFoodItems.BURNT_PUDDING, "The ultimate forbidden dessert with sourness cranked up to the max. Just one is enough to trigger an adrenaline rush and make a youkai dance for an entire night, but after the rush you can't help but say \"I'm all burnt out.\"", "究极加料、一颗就调动起身上包括纪胺肾上腺激素等多神兴奋元素疯狂舞动的禁忌甜食,妖怪食用后可以疯狂舞蹈一整夜,但是兴奋过后会不由地感到“我燃尽了”。");
        this.addDescription(NMIFoodItems.BUTTER_STEAK, "Simple yet difficult. This dish can change drastically at different temperatures or with different beef. By the way, the mistress of the Scarlet Devil Mansion prefers medium rare.", "简单而复杂，根据火候和食材的选择，呈现出不同感觉到基础西餐。顺带一提红魔馆的那位§m指的应该还是蕾米莉亚·斯卡雷特§r喜欢的是三分熟。");
        this.addDescription(NMIFoodItems.CANDIED_CHESTNUTS, "The result of simmering chestnuts in honey. The chestnut's delicate yet rich flavor effectively balances out the sweetness.", "把果子用蜂蜜熬煮之后的成品。栗子里温和而浓郁的味道,可以有效地平衡外在的甜味。");
        ...
        this.addDescription(NMIFoodItems.CAT_FOOD, "Orin said Satori used to make this simple dish for her when she first took her in. The warm taste of velveted flour sprinkled on top of fish has always been remembered fondly by her.", "据说是阿燐刚刚被觉收养时、觉常做给她的简易盖浇饭,面粉勾芡后淋在鱼肉上,那种温柔的味道一直留在燐的记忆里。");
        this.addDescription(NMIFoodItems.CAT_KULULI, "Mellow heart covered in crispy caramel coat. An astounding experience is only possible through such changing textures filled with flavors. No wonder they called it \"Angel's Bell\". . . and check out what's in the bell! It's a kitten!", "迷人的焦糖脆外壳与软糯香浓的内心,无论在口感层次变化或者味觉体验都堪称一绝,不愧是“天使的铜铃”一一咦?铃铛里居然还藏了只小猫咪!");
        this.addDescription(NMIFoodItems.CAT_PIZZA, "Pizza with various toppings, a perfect balance between nutrition and impressions, especially the rich flavor coming from caramelized onions offering layers of joy for your tongue. However, biting into a cute kitten-shaped pizza has been proven difficult.", "在发酵的圆面饼上面覆盖各种配料烤制而成,完美兼顾了营养和品相,焦糖洋葱的醇香滋味更是为其带来了多重的舌尖享受。可爱的猫咪外形让人有些不忍下嘴呢~");
        this.addDescription(NMIFoodItems.CATS_PLAYING_IN_WATER, "Kitten-themed stuffed toast. First, scoop out the loaf from the inside, then layer with cream, peach jam, cream again, and cover it with toast. Next, add in the crystally jelly, make it like a wave of water by covering it with cream dyed blue, and finish it with the last piece - a chocolate kitten. Now you have an interesting dish where it looks like a kitten playing on water.", "猫咪主题的吐司盒。把一整个方块吐司挖空,底部涂上一层奶油,放入一层桃子果酱,再涂上一层奶油,铺一片吐司,加入晶莹剔透的白凉粉,最后再用调色奶油映照出蓝色的水面效果,放入巧克力做的猫咪,就成了一副有趣的猫咪戏水图了。");
        this.addDescription(NMIFoodItems.CHEESE_EGG, "Okuu said Satori used to make this dish for her when she first took her in. Creamy rich cheese mixed into an omelette creates and irresistible snack.", "据说是阿空刚刚被觉收养时、觉常做给她的料理,在蛋饼里混入浓香的芝士,让人无法拒绝的小吃。");
        this.addDescription(NMIFoodItems.COLD_DISH_CARVING, "Fresh fruits and vegetables carved into the shape of a rose. What makes this dish difficult is not the ingredients, but the requisite knife skills.", "将鲜果蔬菜雕刻成鲜花的模样，虽然材料简单，但却非常考验刀工。");
        this.addDescription(NMIFoodItems.COLD_TOFU, "An appetizer for cooling off in summer. Simple and refreshing.", "夏天的消暑下酒菜，简单爽口。");
        this.addDescription(NMIFoodItems.COLORFUL_JADE_FRIED_BUNS, "Pan-fried buns with a rainbow aura! Some hardcore enthusiasts say only pork filling is authentic.", "散发着七彩的气场的高级生煎包。据说有些生煎原教旨主义者尖锐地反对加入猪肉以外食材的做法。");
        this.addDescription(NMIFoodItems.COOKING_TOFU, "A common family dish. In order to make the tofu as tender as possible, the heat must be carefully controlled when cooking.", "常见的家常菜，但也讲究烧制的火候，才能将豆腐的鲜嫩口感得到最大展现。 ");
        this.addDescription(NMIFoodItems.CREAM_STEW, "An easy to make creamy soup. It tastes great regardless of whether you eat it with bread or as is.", "制作家常奶油浓汤，制作方法简单，无论是蘸面包还是当做炖菜来吃都是非常不错的料理。");
        this.addDescription(NMIFoodItems.CRISP_CYCLONE, "Crush the shell of insects and mix them into noodles for a crunchy and delicious dish. A strange and unique dish with a sense of otherworldly wonder.", "将虫类的甲壳磨成大碎块,拌入面中,吃起来香脆又下火,有一种别样的异世界猎奇感的奇怪料理。");
        this.addDescription(NMIFoodItems.DARK_CUISINE, "The embodiment of \"failures.\" An indescribable cluster of mess with a dark aura. No one in their right mind would want to eat it, right?", "烹饪失误、散发着黑色气场的不明物质，不会有人想吃这种东西……吧？ ");
        this.addDescription(NMIFoodItems.DEEP_FRIED_CICADA_SHELLS, "The molted shells of cicadas are used as medicine to clear the throat and improve eyesight. Becomes crispy after frying and is quite popular.", "蝉科的昆虫黑蚱羽化后的蜕壳，可以入药，有利咽开音，明目退翳之效，香炸后口感酥脆，颇受欢迎。");
        this.addDescription(NMIFoodItems.DEPRESSED_CHEESE_STICKS, "A snack popular among gloomy youkai. The uniquely bitter ginkgo and creamy rich cheese blend together to create a distinctly sweet aftertaste. I have no idea why though.", "在一些阴郁的妖怪中流行的零食,在浓郁的芝士中混有白果独有的苦味,能让味觉产生强烈的回甘后味,但我完全无法理解。");
        this.addDescription(NMIFoodItems.DEW_BOILED_EGGS, "Eggs boiled with dew are sweeter than regular boiled eggs. If you can get the timing right, you can get a tender yolk that breaks with the slightest shake.", "采集了清晨的露珠煮成的蛋，比一般的水煮蛋多出了一种甘甜的味道，为了保持鲜嫩只煮到半熟，蛋黄水嫩得似乎稍加晃动就会流出来。");
        ...
        this.addDescription(NMIFoodItems.DUMPLING, "One of the famous recipe from Miss Meiling's hometown from the other side of the ocean! They don't look impressive, but I promise you that they have a lot to show inside! First, you need to repeatedly knead the dough until it's chewy and no longer sticky. Then add whatever ingredients you want in them. Seal them, and then boil them! It's almost magical how delicious they are!", "在海的另一边，红美铃小姐的家乡的著名的食谱，用面粉制作且来的筋道的面皮，在此之中将任意喜欢的食材往里面包入，再往沸腾的热的水那里放入且煮熟，就往超级美味的食物这个给成为了，只要将外表给看的话是朴素无华，内里把世间的宝藏给包着。");
        this.addDescription(NMIFoodItems.EEL_EGG_DONBURI, "Thick slices of eel coated with gourmet soy sauce, topped with a layer of silky raw eggs. Try mixing the egg with rice and giving it a golden look, so that every of your taste buds will feel satisfied!", "厚切的鳗鱼块抹上特调酱汁,再覆盖一层软嫩的生蛋,在食用前将其搅拌得金灿灿的样子,吃下去超级满足!");
        ...
        this.addDescription(NMIFoodItems.ENERGY_STRING, "A skewer made of beef, onion, and pumpkin. The onion's tartness and pumpkin's sweetness mitigates the greasy beef, giving the skewer a refreshing taste.", "牛肉搭配洋葱、南瓜烤成的串串。巧妙地利用了洋葱的刺激与南瓜的甜味去除肉质的油腻，食之更加清爽。");
        this.addDescription(NMIFoodItems.FAILING_SAKURA_SNOW, "A premium sushi dish. The pink tuna upon the white rice resembles sakura petals on white snow, making this an incredibly beautiful dish.", "高级寿司的一种，粉红色的高级生鱼片盖在白米饭上，就如樱花飘落在白雪上，有着不可思议的美感。");
        this.addDescription(NMIFoodItems.FANTASY_IS_ALL_THE_RAGE, "A dish which requires unwavering focus and a very precise control over the flame to cook the meat into a perfect medium-rare. Its dark red hue laid in the shape of a destructive tornado brings out an oppressive sense of foreboding. Eating it makes you feel like you're on top of the world.", "对火候要求极其苛刻的一道菜,需聚息凝神地将肉品烤至完美的三分熟。暗红的色调以及极具破坏性的龙卷风形状,带来了山海欲来的压迫感。一口下去,有种仿佛征服了天下的快感。");
        this.addDescription(NMIFoodItems.FISH_LEAPS_OVER_DRAGON_GATE, "A leaping carp on the outside, precious treasures on the inside. The ultimate dish no feline can resist.", "外表是鲤鱼起跳的造型,剖开后尽是梦幻的宝藏,是猫科动物无法抵抗的究极美食。");
        this.addDescription(NMIFoodItems.FLOWERS_BIRDS_WIND_AND_MOON, "A literal manifestation of the phrase \"flower, bird, wind, and moon\", as well as a triangular cake made in Miss Yuuka's image. Its just as elegant as her, but with one of my own feathers on top of it, it should still be a pretty interesting dish. . . Maybe?", "牵丝攀藤地解升“花鸟风月”一词,同时想象着幽香小姐做出来的三角蛋糕。整体风格就像她本人一样风雅,不过上面插了一根我的羽毛,应该还算有趣吧?");
        this.addDescription(NMIFoodItems.FLOWING_WATER_NOODLES, "Rather than being tasty, these noodles are more about being fun.", "比起好吃，流水素面更多的是好玩。");
        this.addDescription(NMIFoodItems.FRIED_HAGFISH, "One of my signature dishes. These bizarre-looking lampreys were once the talk of Gensokyo. After frying, they gain a smooth and crispy texture, making them a very popular dish.", "本店招牌。长相怪异的八目鳗在喜欢尝鲜的幻想乡曾一度成为话题，油炸后爽滑酥嫩，深受大众喜爱。");
        ...
        this.addDescription(NMIFoodItems.FRIED_PORK_SHREDS, "A home dish made using pork, chili pepper, and other ingredients. It has a strong flavor.", "以猪肉作为主要食材制作而成的家常菜，口味偏重。");
        this.addDescription(NMIFoodItems.FRIED_SHRIMP_TEMPURA, "An iconic Japanese dish of the Outside World. Fresh shrimps are coated in flour and deep-fried until they are golden and crispy. Just the sight of it is enough to make one drool!", "“天妇罗”又名“天麸罗”。将新鲜大虾暑上面粉做的罗衣,放入油锅炸至金黄酥脆,再控油捞出,隔壁家的童子都馋哭了。");
        this.addDescription(NMIFoodItems.FRIED_TOFU, "A common family dish. Supposedly the favorite food of Inari gods and fox youkai.", "常见的家常菜，传说中是稻荷神的狐狸使者最喜欢的食物。");
        this.addDescription(NMIFoodItems.FRIED_TOMATO_STRIPS, "\"Why are potato fries and ketchup forever the norm? I want fries made from tomato! Not only that, I also want the sauce to be made from potato!\"§n-- Seija§nDeep fried tomato covered with flour and drizzled with homemade potato sauce gives it a distinguishing taste.", "”为什么炸土豆条和番茄酱永远是标配?我不仅偏要炸番茄条,我还要独独给它淋上土豆酱!”§n-- 鬼人正邪§n把西红柿裹上面粉后放到油锅炸一炸,出锅后淋上自制土豆酱,尝起来也算是别有一番趣味。");
        ...
        this.addDescription(NMIFoodItems.GAME_SOUP, "A stew made with vegetables and high-quality Iberico pork. Full of flavor, fragrant yet not greasy. Arguably the best peasant dish.", "用农家蔬菜佐以优质黑毛猪肉炖煮的烩锅，口感饱满，香浓却不油腻，是农家人最高级的大菜。");
        this.addDescription(NMIFoodItems.GENSOKYO_BUDDHA_JUMPS_OVER_THE_WALL, "A variation of an iconic cuisine from an ancient Eastern civilization. It is said that even a monk would walk away from enlightenment, jump over a wall to taste this dish. It is really that amazing!", "由东方文明古国最强料理改造而来,据说得道的真佛也会因为它的气味夺墙而走,摒弃斋戒,真的是很神奇!");
        this.addDescription(NMIFoodItems.GENSOKYO_STAR_LOTUS_SHIP, "The pumpkin ship sails into fantasy with a crew of fantastical ingredients on the river of lotus seeds. It's said that anyone who consumes this dish will be spirited away into a dream. As for what kind of dream, that depends on the person.", "以南瓜做的船,承载着如梦似幻的食材,在莲子铺成的河上驶入幻想。据说每每享用完这道料理,都会有如梦方醒的感觉。至于究竟是何种梦境,便是因人而异了。");
        ...
        this.addDescription(NMIFoodItems.GINKGO_AND_RADISH_PORK_RIB_SOUP, "A soup that originates from Meiling's homeland. Not only is it the perfect blend of looks, smell, and taste, but it is also very nutritious.  How to Unlock", "来自红美铃老家的㷛汤技巧，色香味俱全，益气补血。");
        ...
        this.addDescription(NMIFoodItems.GLUTINOUS_RICE_BALLS, "One of the famous recipe from Miss Meiling's hometown from the other side of the ocean! They don't look impressive, but I promise you that there's a lot of sweetness inside! You need to use sticky rice as flour and make a small sphere, hide some sweet ingredients inside and boil them in hot water, and they can become a super tasty dessert!", "在海的另一边，红美铃小姐的家乡的著名的食谱，用糯米揉且成的小的团，在此之中将甜的食材给包入，再往沸腾的热的水那里放入且煮熟，就往超级甜又可口的小吃成为，只要将外表给看的话是朴素无华，内里把世间的甜蜜给包着。");
        this.addDescription(NMIFoodItems.GOLDEN_CRISPY_FISH_CAKE, "Don't underestimate these \"cakes\" made out of sweet honey and fish paste. When deep fried, they will turn golden brown!", "在鱼馆内加入适量蜂蜜搅拌后,碾压成鱼饼,投入油锅炸至金黄色,随炸随食。");
        this.addDescription(NMIFoodItems.GRAND_BANQUET, "All premium ingredients, braised under exquisite heat control, which enhances the flavor further! The meat is tender and juicy. Those who tried it will never forget it!", "奢侈地选用了一系列高级食材炖煮成烩锅，通过火候的精妙控制，将食材之间的特点全部提炼了出来，肉质鲜嫩多汁，香滑入味，令人其味无穷。");
        this.addDescription(NMIFoodItems.GREEN_BAMBOO_WELCOMES_SPRING, "A variety of fresh and tender ingredients steamed inside a bamboo with multiple sections create a dish which sends a message. The fresh, jade-colored bamboo gives guests a new experience in terms of taste and sight in addition to providing a grand welcome for spring.", "将各种鲜嫩的食材放入药节竹简蒸熟,寓意节节高升。而春竹翠绿娇艳的样子,既给客人带来视觉味觉上的新意,还蕴含着迎春的美好寓意。");
        this.addDescription(NMIFoodItems.GREEN_FAIRY_MUSHROOM, "Essentially a mix of mushrooms and herbs. The name gives a strange sense of wonder to it, however.", "本质上是野菜拌蘑菇,但因为这个名字多了一些奇妙的童话感。");
        this.addDescription(NMIFoodItems.GRILLED_HAGFISH, "One of Mystia's signature dishes. I wanted to break the stereotype that \"restaurants with red lanterns all sell grilled birds.\" Did you know that lampreys can effective treat night blindness? They used to be a rare delicacy.", "本店招牌。为了打破红灯笼店就是烤鸟肉店的成见，特意选择了对夜盲症有奇效的八目鳗，据说在过去还被视作珍宝。");
        this.addDescription(NMIFoodItems.GRILLED_PORK_RICE_BALLS, "A common and affordable rice ball. By adding grilled pork to the rice, it gains a chewy texture and a delicious new taste.", "常见的平价饭团，在饭团中放入烤制后的猪肉，为其增加了一份香浓的嚼劲。");
        this.addDescription(NMIFoodItems.HEART_PORRIDGE_GRUEL, "Tremella congee with lotus seed. Slightly sweeter than regular congee. Moisten the throat with no aftertaste. A comfort food full of nutrients that are good for the heart and mind.", "口味偏甜、营养丰富的银耳莲子粥。滋润而不腻滞,还具有养心·安神的功效。");
        ...
        this.addDescription(NMIFoodItems.LOOKING_UP_AT_THE_CEILING_FRUIT_PIE, "The head of a fish juts out through the pie, as if it were looking at the Underworld's ceiling. A dish filled with despair, in contrast to Hell.", "在水果派里探出一个鱼头,仿佛看着地底的天花板,充满了与地狱相衬的绝望气息。");
        this.addDescription(NMIFoodItems.LOTUS_FISH_RICE_BOWL, "A snow-white dish adorned with dark green mint leaves, crystal dew rolls around in the leaves, complimented by a white lotus in the center to give it a \"hermit-like\" touch. Each lotus lamp consists of a fresh pink lotus petal as the base, carrying an ensemble of mashed tuna and lotus seeds. Healthy and delicious.", "洁白的盘中铺上碧绿的荷叶,叶上还滚动着晶莹的水珠,盘中央一朵白荷则增添了“仙气”。每一盏里都以鲜嫩的粉色荷花花瓣为底,盛着极上金枪鱼、莲子组成的“鱼米盏”,又好吃又健康。");
        this.addDescription(NMIFoodItems.LUOHAN_VEGETARIAN, "A vegetarian dish from Buddhist cuisine. It's said that authentic Buddha's Delight is made with 18 different ingredients with complex and elaborate procedures. The finished dish is a colorful blend of elegance, with a light and fragrant taste. One could say this is the most luxurious dish in Buddhist cuisine.", "源自佛门的斋菜。传闻正宗的罗汉斋用十八种原料制成,工序复杂考究,成菜色泽缤纷雅致,味道清淡香郁。堪称佛门最奢华的一道素菜。");
        this.addDescription(NMIFoodItems.MAD_HATTER_TEA_PARTY, "Dessert takes inspiration from Makai's tea party. At first glance, it's simply a teapot made of chocolate, but inside the teapot, it's filled with layered cream cakes, decorated with mushroom and broccoli, just like the candy house from the fantasy. A dessert of happiness, filled with dreams and mystery.", "以魔界茶会为印象制作的甜品。表面看起来是一个巧克力做的茶壶,茶壶的肚子里是层层堆叠的奶油蛋糕,周围装饰着蘑菇和西蓝花,就像某个故事里的巧克力房子一样,是充满了梦幻和不可思议的幸福甜品。");
        this.addDescription(NMIFoodItems.MAGMA, "A stew made from premium beef and truffles. Super hot and spicy! Got the name because the stew is bubbling hot like lava. A non-spicy version also exists for weaklings.", "用高级牛肉和松露炖煮而成的烩锅，最初以麻辣为特色，因炖煮中冒出的气泡如岩浆而得名，款款而起的香味更是让人食指大动。改良后也增加了不辣的版本。");
        this.addDescription(NMIFoodItems.MAOYU_LAVA_TOFU, "Looks like it's on fire! A famous delicacy in MC Gensokyo, attracting many to try its tongue-tingling flavor.", "方形的火山毛玉造型，仿佛着了火的熔岩豆腐，是MC幻想乡非常著名的特色料理，受到喜欢舌苔刺激的人的追捧。");
        this.addDescription(NMIFoodItems.MAOYU_TRICOLOR_ICE_CREAM, "Very appealing from color to flavor. It can't be missed when traveling in MC Gensokyo.", "方形的三色毛玉冰淇淋，从颜色到口味上都非常惹人喜爱。去MC幻想乡旅游时，几乎是人手一份的招牌甜品。");
        ...
        this.addDescription(NMIFoodItems.MILKY_MUSHROOM_SOUP, "A wonderful soup with a rich creamy base that you can't stop eating once you taste it. Easy to make, the ingredients are readily available. Oh, it's also very nutritious.", "浓郁的奶香汤底煮出来的魔性之汤,尝下第一口就无法停下来。制作简单、材料随处可见,还拥有极高的营养价值。");
        ...
        this.addDescription(NMIFoodItems.MOON_LOVERS, "After hearing the popularity of \"Koibito\" cookies in the Outside World, Eientei invented their own.", "外界似乎很流行使用□□恋人作为地区伴手礼，永远亭也不甘落后潮流，推出了自己的版本！");
        this.addDescription(NMIFoodItems.MOONLIGHT_DUMPLINGS, "A special Eientei mochi. They \"taste like moonlight\" because they are made with the rare moonlight grass.", "永远亭特产改良的麻薯团子，加入了高级食材月光草，造型可爱的同时，还有“月光一样的口感”。");
        ...
        this.addDescription(NMIFoodItems.ORDINARY_SMALL_CAKE, "A small snack containing a surprising amount of calories. Supposedly can make one stronger. It says \"Eat Me\" on it, which is very tempting. Be careful if you eat too many, you might gain weight...", "有着惊人热量的小点心,据说能迅速强健体魄。上面写着“吃掉我”,非常诱人。吃多了估计会长胖吧 ……");
        this.addDescription(NMIFoodItems.PAN_FRIED_MUSHROOM_MEAT_ROLL, "A common but delicious delicacy with a balanced mix of meat and vegetables. Two different mushrooms wrapped in carefully selected meat creates a layered flavor for the taste buds.", "荤素搭配均匀,味道也很好的常见佳肴。用两种不同口感的菇类,包裹着精挑细选的嫩肉,给味蕾带来层次感十足的享受。");
        this.addDescription(NMIFoodItems.PAN_FRIED_SALMON, "Made by pan-frying a whole salmon until the skin is crispy and the inside is tender. I heard they use asparagus in the Outside World, but I guess we'll make do with fresh bamboo shoots. Just call it Gensokyo-style!", "将整块带皮的三文鱼煎至外焦里嫩，配上鲜嫩的竹笋——不过外界这个菜谱一般是芦笋，这也算是幻想乡式的融合菜吧。");
        this.addDescription(NMIFoodItems.PEACH_BLOSSOM_GLAZE_ROLL, "Cute and pink peach flowers turned into crystally jelly, thanks to gelation technology. The mellow red bean paste inside preserves the sweet romance of the season.", "通过胶凝化技术,把粉嫩可爱的桃花制成晶莹剔透的琉璃果冻外皮,裹着糯叽叽的豆沙馅,记录季节的浪漫与甜蜜。");
        this.addDescription(NMIFoodItems.PEACH_BLOSSOM_SOUP, "A recipe from Heaven, made from fresh peach and morning dew. Not only is this dish sweet and fragrant, but it's also photogenic and healthy.", "来自天上的配方，采摘新鲜的桃花，配以清晨的甘露水煮而成，不仅芳香清甜，而且具有祛病美容的神奇功效。");
        this.addDescription(NMIFoodItems.PHOENIX, "\"Huh, so that's what's inside that turkey's belly.\" -- Kaguya Houraisan§nA flour turkey with everyday ingredients as filling and honey brushed over. Has a crispy surface and juicy interior.", "用面粉烘焙出烤火鸡的形状，在表面刷上蜂蜜，肚子里塞满食材，进行充分的烘烤。出炉的假烤鸡有着香脆的外皮和多汁的内馅。");
        this.addDescription(NMIFoodItems.PICKLED_CUCUMBERS, "By cutting and marinating cucumbers in brine and other seasonings, they gain a magical and mouth-watering taste.", "将黄瓜切段后用盐等调味腌制,出现了神奇而难以抗拒的风味。");
        this.addDescription(NMIFoodItems.PIG_DEER_BUTTERFLY, "Inspired by the hanafuda combo, pork and venison are stewed in clear soup and seasoned with flowers to bring out the freshness of the ingredients.", "脱胎于花礼的猪鹿蝶牌型，将猪肉和鹿肉清炖，佐以花朵引出食材本身鲜味的精致料理。");
        ...
        this.addDescription(NMIFoodItems.POETRY_AND_GINKGO, "Named after the ginkgo trees in the Temple of Confucius, they are fragrant, sweet, chewy, and can even cure coughing and hangovers.", "以选用孔庙“诗礼堂”前银杏树所结果实烹制而得名，清香甜美，柔韧筋道，可解酒止咳。");
        this.addDescription(NMIFoodItems.POISONOUS_GARDEN, "A hodgepodge of various \"poisonous\" ingredients. Precise handling of each ingredient allow for the retention of \"poison\" in the ingredients to varying degrees, letting every guest experience the exact level of thrill they wish for.", "用各种“毒食材”混合炖煮的杂炊。通过细致而精巧的食材处理手段,能够不同程度地保留食材中的“毒性”,让不同需求的客人均能体验到他们想要的刺激。");
        this.addDescription(NMIFoodItems.PORK_AND_TROUT_SMOKED, "A dish made with smoked pork and trout. Simple to make and absolutely delicious.", "把猪肉鳟鱼放在一起熏制而成，是简单好吃的肉食料理，也比较能保存。");
        this.addDescription(NMIFoodItems.PORK_RICE, "A common family dish. The aromatic sauce drizzled over soft rice blends with the taste of the pork. Makes anyone hungry.", "常见的家常菜，看上去颗颗饭粒饱满，淋上的香酱与猪肉的口感融为一体，令人口感倍增。");
        ...
        this.addDescription(NMIFoodItems.PSEUDO_JIRITAMA, "It is said that the shirikodama is the tailbone of a human and kappa's favorite food. In the past, it was taken from humans through a bloody method. Over time, we created something similar, though it comes at a premium cost.", "据说尻子玉是人类进化后残存的尾骨,是河童一族最喜欢的食物。从前用血腥的方式从人类那里夺取,但是随着时代的进步、已经有料理的方式来替代,只是成本昂贵。");
        this.addDescription(NMIFoodItems.PUMPKIN_SHRIMP_CAKE, "Hollow out a small pumpkin and fill it with shrimp and tofu. Steam it, and you got yourself a sweet, delicious, and very healthy meal.", "掏空小南瓜,用鲜嫩的虾肉和豆腐填充,再进行蒸制,香甜可口,又非常健康。");
        this.addDescription(NMIFoodItems.RAPUNZEL, "Delicately plated spaghetti with shrimp and pumpkin. The sweetness and mellow texture of low-fat low-carole pumpkin make a great replacement for butter, enriching both flavor and nutrition.", "摆盘精致的虾仁南瓜意面。南瓜蒸熟后又甜又糯,用它代替奶油做出来的意面低脂低卡,味道浓郁,营养十足!");
        ...
        this.addDescription(NMIFoodItems.REFRESHING_PUDDING, "A pudding which was made terrifyingly sour, boosting one's energy even more. Just one bite is enough to rid a tired mind of any fatigue. But due to how intense the ingredients are, it's not good for oral health.", "大大提升了酸度的可怕布丁,改良了提神的效果,只要吃一口,就能让困倦的身体打起精神,但因为其用料过于凶猛,很不利于口腔健康 ……");
        ...
        this.addDescription(NMIFoodItems.RISOTTO, "After frying the ingredients, uncooked rice is poured in, which soaks the aroma into the rice. Supposedly originated from a peninsula from the Outside World.", "将食材炒熟之后倒入生米，充分混合米粒和食材香味的外界某个半岛的做法。");
        this.addDescription(NMIFoodItems.ROASTED_MUSHROOMS, "A skewer made from mushrooms. While it's a vegetarian dish, it actually kind of tastes like meat after marinating, breading, and grilling.", "采用蘑菇为原料，经过腌渍、裹粉、油炸，虽然是素食，但味道和肉不相上下。");
        ...
        this.addDescription(NMIFoodItems.SCARLET_DEVILS_CAKE, "A dreamy cake modeled after the hat of the Scarlet Devil. Sweet jam oozes out like blood when cut. A rare dessert from the world of Three Fairies' Hoppin' Flappin' Great Journey!", "以猩红恶魔头上的帽子为原型制作的梦幻甜食，切开会有仿佛血液一般的甜美酱料流出，是「三妖精的蹦蹦跳跳讨伐大作战」世界传来的珍贵料理。");
        this.addDescription(NMIFoodItems.SCONES, "A common British afternoon tea, crisp on the outside and soft on the inside. Usually eaten with jam or cream.", "英式下午茶的常客，外酥内软。一般蘸着果酱或者奶油一起吃。");
        this.addDescription(NMIFoodItems.SCREAMING_ODEN, "Former Hell's most popular party snack. Various ingredients are mixed in with a dash of spice, resulting in a magical dish where you can't stop eating even when drenched in sweat.", "旧地狱中最流行的聚会小吃,将各神食材置入后,加上辣椒刺激,让人汗流满面的同时,却无法停下,是魔力十足的料理。");
        ...
        this.addDescription(NMIFoodItems.SEA_URCHIN_SHINGEN_PANCAKE, "Crystal-clear raindrop cake made from tuna broth, combined with sea urchins, forming an elegant view of yellow like premium champagne. Sesame sauce at the bottom further enhances its texture. It almost feels bad to think about its fate being a dessert rather than a delicate, fine-crystal art.", "以金枪鱼高汤制作的饼身清透干净,与新鲜海胆组成高级的香槟色系搭配,底层的胡麻酱更增一丝醇厚的口感。如此玲珑的甜品,让人不忍破坏这晶莹剔透的美丽。");
        ...
        this.addDescription(NMIFoodItems.SECRET_DRIED_FISH, "Sun-dried fish marinated with secret spices. They are crispy, delicious, and easy to store, making them a popular snack at homes.", "用秘制的香料将小鱼干腌制后晒干，酥脆想口的同时又易于保存，寻常人家都喜欢在家中保存一份。");
        this.addDescription(NMIFoodItems.SECRET_MUSHROOM_CASSEROLE, "A secret recipe created by a human magician studying fungi for a long time. The ingredients are freshly picked mushrooms from the Forest of Magic, which are said to possess a higher nutritional value than those found elsewhere.", "长期专研于蘑菇学的人类魔法使所创的秘制菜谱。食材均选自魔法森林所产的新鲜菌类,据说较其他地方产出的菌类有更高营养价值。");
        ...
        this.addDescription(NMIFoodItems.SHIRAGA_SADAMATSU, "The white deer and the pine tree are both symbols of longevity, held in high esteem by Taoists who seek a longer life, hence the painting of a deer and a pine tree. This is a dish made in the painting's image.", "白鹿和松树都有长寿的寓意,深受追求长生的道教人士的推崇,于是有“鹿寿松贞”之画,即一只白鹿立于松树之下。这道菜就是以这幅画为印象创作出来的~");
        this.addDescription(NMIFoodItems.SKINNY_HORSE_DUMPLING, "Looks like elongated dango on the outside. Cutting it open reveals a variety of pictures, breathing a fresh sense of life into dango. Apparently Yashouma Dango symbolizes sarira. Isn't that the Buddha's ashes?", "外表看起来像是拉长了的团子,切开后中间裹着各式各样的图案,大大增加了团子的新鲜感。据说瘦马团子象征佛舍利,那不就是佛祖的骨灰吗?");
        this.addDescription(NMIFoodItems.SNOW_WHITE, "A premium stew made with lamprey, pufferfish, and seaweed. The name means \"white snow.\" The most luxurious family dish, if you can call it that.", "使用鲜美的八目鳗与河豚，在佐以海苔炖煮而成的高级烩锅，由于煮的过程中会飘出纯白的泡沫而得名，是非常高级的家庭料理。");
        this.addDescription(NMIFoodItems.STEAMED_EGG_WITH_SEA_URCHIN, "A simple dish which can be made by steaming egg and sea urchin until the sea urchin eggs change color. Dig in with a spoon to reveal the delectable smell of sea urchin and steamed egg guaranteed to linger on your senses.", "将鸡蛋加入海胆蒸至海胆黃变色就可以出锅的简单料理。吃的时候用勺子挖下去,一口一勺,海胆和蛋羹互相融合濟透的美味就在味蕾上蔓延了。");
        ...
        this.addDescription(NMIFoodItems.STRENGTH_SOUP, "A soup with a perfect balance between meat and vegetables and seaweed and boar meat. It can quickly supply your body with all the energy you need.", "荤素搭配的美味汤羹，使用了野猪肉和海带㷛煮而成，能最快捷地补充身体所需能量。");
        this.addDescription(NMIFoodItems.SUPERME_SEAFOOD_NOODLES, "Al dente noodles stewed in seafood broth, filled with seafood umami, a luxurious family dish. One bowl is enough to recall the deep memory of umami hidden by the sea", "以海鲜汤料煨煮的汤面,劲道爽滑,汤浓鲜美,是一道非常豪华的家常菜。凭一碗海鲜面,便能让人记住深藏着的大海的味道。");
        this.addDescription(NMIFoodItems.TAICHI_BAGUA_FISH_MAW, "A classic Taoist dish requiring very precise steps. The fish maw must be cut into thin slices-the thinner the better-the trigrams must be constructed meticulously, paying close attention to the placement of the lines. Carefully steam it and you get a vivid image of the eight trigrams with soft and delicious fish maws.", "做法极其讲究的道教经典名菜。鱼肚片片,要愈薄愈好;太极图则要注意造型圆整、八卦形等距,最后再经过细心蒸煮,才能呈现出这道形象生动、鱼肚软糯的道家名菜。");
        this.addDescription(NMIFoodItems.TAKETORIHIME, "\"The so-called Princess Kaguya is no different from this dish!\" -- Fujiwara no Mokou§nActually, it's just steamed bamboo with sticky rice, meat, and truffle. Surprisingly, the bamboo's fragrance mitigates the greasy meat.", "在永远亭就地取材，使用新鲜的食材和米饭一起塞进竹筒中蒸熟。饭被竹子的清香充分浸润后，中和了山猪肉带来的油腻。");
        ...
        this.addDescription(NMIFoodItems.THE_BEAUTY_OF_HAN_PALACE, "Pure white tofu symbolizing Diao Chan's purity and a pond loach hinting at Dong Zhuo's treachery. A dish that reminds one of Wang Yun's scheme with Diao Chan, using her beauty to depose the tyrant Dong Zhuo, naturally imbuing a sense of culture into the dish.", "用豆腐的洁白来形容貂婵的纯洁,以泥鳅的钻营来影射量卓的奸滑。让人在品尝中,想到王允献貂婵,巧使美人计而除奸贼董卓的故事,自然为美食增添了文化的含量。");
        this.addDescription(NMIFoodItems.THE_DREAM, "A two-layered cake themed after flowers. A bouquet of flowers affixed upon delicate, soft cream, oozing with sweet fragrance. A blue butterfly gently rests atop, never leaving—it's not a dream, and yet it's beyond a dream.", "以花卉为主题的双层奶油蛋糕。锦猴花团铺在细腻的奶油上,散发出丝丝香甜,蓝色的蝴蝶轻轻驻足,久久不归。这不是梦境,却胜似梦境。");
        this.addDescription(NMIFoodItems.THE_MARS, "Bottom of the plate solely designed to recreate the surface of Mars, topped with a premium mix of crab jelly and white wine grape jelly, only possible through molecular gastronomy. A delicacy combining the refreshing, chilly texture of the crab and the raindrop-like fruit jelly filled with a white wine aroma. Metaphorically, it's a droplet of water on planet Mars, representing the last hope.", "特别定制的盘底如火星地表一般,上面盛放着顶级的螃蟹冻以及白葡萄分子技术制作的果凝。螃蟹口感冰凉顺滑不腻,果凝如水滴一般,而且带着淡淡酒香。寓意火星上一滴水珠,代表着最后的希望。");
        this.addDescription(NMIFoodItems.THE_SOURCE_OF_LIFE, "At first sight, it's a mysterious planet covered with layers of clouds, but it's only a raw egg once the \"planet\" is opened up! The \"raw egg\" is actually tremella soup \"egg \" white with pumpkin paste \"egg \" yolk. Refreshing taste with rich pumpkin flavor.", "初见就像是云山雾罩的神秘星球,打开一看“星球”里竟然摆了个生鸡蛋?仔细看蛋液其实是银耳汤,蛋黄则是南瓜泥。吃起来口感清爽,还有香浓的南瓜味。");
        this.addDescription(NMIFoodItems.TIANSHI_BRAISED_CHESTNUT_MUSHROOMS, "The Divine Spirit Mausoleum is located in Senkai, so the chestnuts there are said to contain divine energy. I can't really tell the difference though... Wouldn't it be more practical to stew chestnuts with mushrooms and turn this intangible divine energy into a pot of sweet and savory stew?", "神灵庙位处仙界,所栽神的栗树据说都蕴含仙气。但我是分辨不出啦 …… 将栗子佐以蘑菇焖煮,把看不见摸不着的仙气浓缩成一锅鲜甜味美又解馋的杂烩,岂不是更实在?");
        this.addDescription(NMIFoodItems.TOFU_MISO, "An easily prepared soup commonly found in izakayas. A clean and simple delicacy that uses tofu to highlight its freshness.", "居酒屋常见的快手汤羹，使用了豆腐来提鲜，最简单又最原始的美味。");
        this.addDescription(NMIFoodItems.TOFU_POT, "A cheap stew made of tofu. It's the most common stew in the izakaya thanks to the smooth and tender texture and its rich nutrients.", "由豆腐炖煮而成的烩锅，滑嫩的口感再加上其本身具有的较高营养价值，使这道平价料理成为居酒屋最常见的烩锅。");
        ...
        this.addDescription(NMIFoodItems.TOON_PANCAKES, "A pancake made with the \"poisonous\" red toon. It tastes bitter at first, but leaves a sweet aftertaste in the mouth. REMEMBER: blanch the red toon in water before serving it to normal guests!", "用有“毒”的野菜一一香椿制成的煎饼。初尝有种苦苦涩涩的味道,嚼下去后口齿留甘。牢记!给普通客人食用须先将香椿用开水焯过一遍!");
        this.addDescription(NMIFoodItems.TWO_HEAVENS_ONE_STYLE, "According to legends, a human swordsman invented this dish when making a bet with an oni and won with it. Made using grilled wild game, eating this dish gives you a massive strength boost and wakes your primal instinct.", "传说中与鬼立下赌约并获胜的人类剑士所创下的烤串流派，特别使用了野性十足的肉类烧制而成，食之有种冲天的气魄，让人惊叹不已。");
        ...
        this.addDescription(NMIFoodItems.UNCONSCIOUS_MONSTER_MOUSSE, "A precious mousse modeled after the hat of an unconscious youkai. Gaze into the infinite darkness upon cutting it and let it etch an unforgettable taste into your very soul. A rare dessert from the world of Three Fairies' Hoppin' Flappin' Great Journey!", "以无意识妖怪的帽子为原型制作的深沉甜食，即使切开感受到的也是无尽的黑暗，但香醇程度令人流连忘返，是「三妖精的蹦蹦跳跳讨伐大作战」世界传来的珍贵料理。");
        this.addDescription(NMIFoodItems.VEGETABLE_SPECIAL, "A salad made of fresh vegetables. The low calories make it the perfect diet food for young girls.", "用新鲜的蔬菜生拌而成的沙拉，口感清新，可以去除嘴里的油腻。不知为何被年轻的姑娘们奉为减肥圣餐。");
        this.addDescription(NMIFoodItems.WARM_RICE_BALL, "A simple and cheap rice ball with trout and onions, merging the juicy seafood with the tart onion. Nutritious and delicious.", "常见的平价饭团，内陷加入了鳟鱼和洋葱，融合了海鲜的细腻口感与洋葱的炽热，无论是营养还是口感都属上佳。");
        this.addDescription(NMIFoodItems.WHITE_PEACH_EIGHT_BRIDGE, "A classic Japanese dessert shaped like a koto. The peach filling colors make them pink. Cute and inviting.", "状似外界古筝的经典和果子，加入白桃内陷之后呈现淡粉色，非常诱人。");
        this.addDescription(NMIFoodItems.YUNSHAN_COTTON_CANDY, "Among Myouren Temple's disciples is a shapeshifting nyuudou whose face easily reminds one of cotton candy. A sweet but not too sweet cotton candy with added peach juice. Its interesting shape makes it very popular with kids.", "命莲寺的弟子中有个能够变幻形态的入道,只要见过他的样子,就很容易联想到棉花糖。加入桃汁制作的棉花糖甜而不腻,造型生动有趣,深受小孩子的喜爱。");
        this.addDescription(NMIFoodItems.ZHAJI, "A stew made with leftovers. Delicious without being wasteful, the best of both worlds.", "使用一些边角料食材杂烩而成的烩锅，享受美味的同时还能避免浪费，可谓一举两得。");
        this.addDescription(NMIIngredientItems.BAMBOO_SHOOTS, "Common bamboo shoots you can find in Bamboo Forest of the Lost.", "从野外采回来的竹笋，较为常见");
        this.addDescription(NMIIngredientItems.BLACK_PORK, "Pork from pigs that breed deep in the mountains. Very high-grade.", "在高海拔深山中圈养的黑毛猪肉，非常高级。");
        ...
        this.addDescription(NMIIngredientItems.CAPSAICIN, "Ultra spicy product made with Lunarian technology, capable of leaving horrible memories for those who dared to try it. Not even sure if it's made with chili. . .", "使用月之科技制作的极辣品,能让食用者留下恐怖的回忆。是不是真的用辣椒做的就说不清了……");
        ...
        this.addDescription(NMIIngredientItems.CICADA_SHELL, "The shell of a cicada that can be found on tree trunks.", "在树干上常常可以采集的昆虫外壳，较为常见");
        ...
        this.addDescription(NMIIngredientItems.FICUS_MICROCARPA, "A medicinal and food plant. Creeping fig seeds, when soaked and then rubbed, will solidify into a crystalline gel after refrigeration. They can be used to make jellies and those alike, which are brilliant desserts to beat the summer heat.", "一种药食两用植物。将薛荔籽浸泡后搓汁,冷藏后会凝固成晶莹剔透的胶状物,可以用来制作果冻和凉粉等,是消暑神品。");
        this.addDescription(NMIIngredientItems.FLOUR, "A common ingredient that can be used in many ways.", "有多种用途，较为常见");
        this.addDescription(NMIIngredientItems.FLOWERS, "A bouquet of colorful and gorgeous flowers. We must show our respects to the task flowers must complete even at the cost of their own lives!", "一朵朵绚丽烂漫的鲜花扎成的花束。花儿们以生命为代价也要完成的事,必须要对此付出敬意!");
        this.addDescription(NMIIngredientItems.GINKGO, "Common ginkgo nut that grows from ginkgo trees.", "白果树的果实，较为常见");
        this.addDescription(NMIIngredientItems.GRAPE, "Grapes cultivated at the Scarlet Devil Mansion, which are commonly used for alcohol brewing.", "在红魔馆种植的用于酿酒的葡萄");
        this.addDescription(NMIIngredientItems.HAGFISH, "A type of migratory ocean fish that can somehow be found in the rivers and lakes of Gensokyo. Somewhat common.", "一种洄游性海鱼但却在幻想乡的河流湖泊随处可见，较为常见");
        ...
        this.addDescription(NMIIngredientItems.LOTUS_NUTS, "The seeds of a very old aquatic plant-the lotus. Lotus seeds have very bitter cores, so accidentally mixing them into a customer's dish must be avoided at all costs. Careful handling is a must.", "非常古老的水生植物--莲的种子。莲子的芯特别苦，千万得处理好，别混到料理给客人吃了。");
        this.addDescription(NMIIngredientItems.MOONFLOWER, "A specialty of Eientei. A plant that grows under the full moon and absorbs its very essence. Very rare.", "永远亭的特产，由满月之夜的月光凝聚，非常珍贵。");
        ...
        this.addDescription(NMIIngredientItems.PUFF_YO_FRUIT, "Weird fruits seen everywhere in Makai. Apparently grants different effects based on the type of person consuming it, which is very peculiar.", "魔界里到处可见的怪异果子。似乎会根据食用者的类型产生不同的食用效果,十分奇特。");
        this.addDescription(NMIIngredientItems.RED_BEANS, "A herbaceous plant that's very adaptable. Eating it can boost one's immune system and prevent diseases. People of ancient times believed diseases were caused by demons, hence legends that say red beans can overcome demons.", "又称赤豆,是适应能力较强的草本植物,食用能够起到增强自身免疫力和抗病能力的效果。古代人觉得中风得病都是疫鬼作柴,所以有“赤豆打鬼”的传说。");
        ...
        this.addDescription(NMIIngredientItems.SUPREME_TUNA, "The highest quality of tuna. Very valuable.", "金枪鱼中的顶级品种，非常珍贵");
        ...
        this.addDescription(NMIIngredientItems.TOON, "A common wild vegetable. Poisonous; eating too much is not recommended. Must be blanched before consuming.", "一种常见的野菜。具有一定的毒性,不建议过量食用,并且食用前须焯水烹饪。");
        this.addDescription(NMIIngredientItems.TREMELLA, "A fungus as beautiful as a flower. It is said that royalty through the ages look upon snow fungus as a life-prolonging product, yet it seems very common in Lunar Capital. Its immaculate white fits Lunar Capital well.", "一种像花儿一样美丽的菌类。据说历代皇家贵族把银耳看作延年益寿之品,但在月都似乎很常见。这种看起来一尘不染的洁白,和月都的感觉很相衬。");
        ...
        this.addDescription(NMIIngredientItems.TWIN_LOTUS, "Its roots grow near bridges, blooming on the water's surface when mature. It possesses a light pink hue and a subtle fragrance, a high-quality ingredient used as festive decorations in the Underworld.", "根茎生长在桥的附近，花朵成熟后会破水而出，淡红色并有淡香味，高级食材，也是地底人的节日装饰。");
        ...
        this.addDescription(NMIIngredientItems.WHITE_RADISH, "Common radish grown in the Human Village.", "人里农田产的萝卜，较为常见");
        this.addDescription(NMIIngredientItems.WILD_BOAR_MEAT, "Boar meat hunted from the mountains. Somewhat rare and tastes of wildness.", "猎人们在山间猎回来的野猪肉，充满野性");
