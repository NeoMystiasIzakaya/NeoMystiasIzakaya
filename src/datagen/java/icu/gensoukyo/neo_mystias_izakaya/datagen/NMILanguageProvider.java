...
public class NMILanguageProvider implements DataProvider {
    ...
    private void addItemTranslations() {
        ...
        this.add(NMIFoodItems.HEART_THROBBING_SURPRISE, "Heart-Throbbing Surprise!", "惊吓！大冒险");
        ...
        this.add(NMIFoodItems.CAUTION_HELLISH_SPICE, "CAUTION!! Hellish Spice!", "地狱激辛警告！");
        ...
        this.add(NMIFoodItems.AGAINST_THE_WORLD, "Against The World!", "逆转天地！");
        ...
        this.add(NMIDrinkItems.FRUITY_HIGHBALL, "Fruity Highball", "果味High Ball");
        this.add(NMIDrinkItems.FRUITY_SOUR, "Fruity Sour", "果味Sour");
        this.add(NMIDrinkItems.MIO, "Mio", "淇");
        this.add(NMIDrinkItems.ZUN_BEER, "ZUN Beer", "超ZUN啤酒");
        this.add(NMIDrinkItems.SANGETSUSEI, "Sangetsusei", "日月星");
        this.add(NMIDrinkItems.UMESHU, "Umeshu", "梅酒");
        ...
        this.add(NMIDrinkItems.AFFOGATO, "Affogato", "阿芙加朵");
        this.add(NMIDrinkItems.SCARLET_MIST, "Scarlet Mist", "红雾");
        this.add(NMIDrinkItems.NEGRONI, "Negroni", "尼格罗尼");
        this.add(NMIDrinkItems.GODFATHER, "Godfather", "教父");
        this.add(NMIDrinkItems.WIND_PRIESTESS, "Wind Priestess", "风祝");
        this.add(NMIDrinkItems.CASSIA_WINE, "Cassia Wine", "冬酿");
        this.add(NMIDrinkItems.FULL_MOONS_EVE, "Full Moon's Eve", "十四夜");
        this.add(NMIDrinkItems.FIRE_RATS_ROBE, "Fire Rat's Robe", "火鼠裘");
        this.add(NMIDrinkItems.JADE_DEW_TEA, "Jade Dew Tea", "玉露茶");
        this.add(NMIDrinkItems.MOON_ROCKET, "Moon Rocket", "月面火箭");
        this.add(NMIDrinkItems.MILK, "Milk", "牛奶");
        this.add(NMIDrinkItems.GRAPEFRUIT_JUICE, "Grapefruit Juice", "红柚果汁");
        this.add(NMIDrinkItems.RAMUNE, "Ramune", "波子汽水");
        this.add(NMIDrinkItems.ICEBERG_KEDAMA_LEMONADE, "Iceberg Kedama Lemonade", "冰山毛玉冻柠");
        this.add(NMIDrinkItems.GIANT_POPSICLE, "GIANT Popsicle!", "“大冰棍儿！”");
        this.add(NMIDrinkItems.DAIGINJO, "Daiginjo", "大吟酿");
        this.add(NMIDrinkItems.COFFEE, "Coffee", "咖啡");
        this.add(NMIDrinkItems.FAIRY_DEW, "Fairy Dew", "妖精雨露");
        this.add(NMIDrinkItems.ICE_CREAM_SMOOTHIE, "Ice Cream Smoothie", "古法奶油冰沙");
        this.add(NMIDrinkItems.ORDINARY_FITNESS_TEA, "Ordinary Fitness Tea", "普通健身茶");
        this.add(NMIDrinkItems.ONI_KILLER, "Oni Killer", "鬼杀");
        this.add(NMIDrinkItems.RIBOVITAN, "Ribovitan", "气保健");
        ...
        this.add(NMIDrinkItems.THIS_SIDE_UP, "This Side Up", "天地无用");
        this.add(NMIDrinkItems.DRUNKEN_BARD, "Drunken Bard", "伶人醉");
        this.add(NMIDrinkItems.DAUGHTER_OF_THE_SEA, "Daughter of the Sea", "海的女儿");
        this.add(NMIDrinkItems.MAKAI_COFFEE, "Makai Coffee", "魔界咖啡");
        this.add(NMIDrinkItems.MOJITO_SPHERE, "Mojito Sphere", "莫吉托爆浆球");
        this.add(NMIDrinkItems.SPACE_BEER, "Space Beer", "太空啤酒");
        this.add(NMIDrinkItems.SATELLITE_ICE_COFFEE, "Satellite Ice Coffee", "卫星冰咖啡");
    }

    private void addItemDescTranslations(){
        
        this.addDescription(NMIDrinkItems.AFFOGATO, "Ice cream with coffee is great for people who are afraid of bitterness but still need caffeine. §n \"It's not like I can't handle the bitterness, I just need a boost.\"§n ——Patchouli", "将冰淇淋融化在咖啡中的做法，对于怕苦又需要咖啡提神的人来说是再好不过的饮料。§n \"我只是需要提神，并不是怕苦。\" §n——帕秋莉");
        this.addDescription(NMIDrinkItems.ZUN_BEER, "The product of a side hustle of a great figure who is deeply connected with Gensokyo. Surprisingly popular.", "某位和幻想乡很有渊源的大人物作为副业的产品，虽然是出于兴趣而研制的啤酒，但意外地十分有人气。");
        this.addDescription(NMIDrinkItems.GIANT_POPSICLE, "A simple yet substantial large ice cube. Sweet and minty. It can revive you with full HP on a hot summer day! A precious treat from the world of the \"Three Fairies' Hoppin' Flappin' Great Journey!\"", "简单又富有重量感的大冰块，有梦幻的甜蜜和薄荷的调味，夏天解暑、让所有人满血复活神奇冰品！是「三妖精的蹦蹦跳跳讨伐大作」战世界传来的珍贵饮品。");
        this.addDescription(NMIDrinkItems.WIND_PRIESTESS, "Minty and creamy. More like a dessert than a drink.§n\"That damn Moriya Shrine Maiden brought this drink from the Outside World and named it after herself! Can she even drink in the Outside World? It's horrible anyway, no wonder why she likes it, tisk.\"§n——An Anonymous Miko", "轻松愉快的餐后酒，薄荷和奶油为主的口感。比起酒精饮料更像甜品。§n\"好像是守矢的巫女从外面带过来的配方，堂而皇之地冠了自己的名字!说起来那家伙在外界能喝酒吗?啊，这玩意儿也完全不像酒就是了，怪不得她会喜欢，啧。“§n——不愿透露姓名的巫女");
        ...
        this.addDescription(NMIDrinkItems.DASSAI, "One of the treasures of the Kiketsu Family. It randomly god this name because Otter Spirits placed enemy loot on the floor, resembling a ritual. It's actually a high-quality sake.", "鬼杰组的战利品之一，因为水獭灵把敌组的战利品摆在地上的样子仿佛祭典，于是随便取的名字。实际上好像是相当高级的纯米大吟酿。");
        this.addDescription(NMIDrinkItems.ONI_KILLER, "The legendary wine said to make even the oni who can hold a seemingly infinite amount of liquor blackout drunk... Though from what I've seen... they all drink it like it's plain water?! The legend isn't reliable at all.", "传说一杯就能让酒量无底洞一般的贵族醉生梦死的传说之酒......但我见到的是......鬼明明都当作凉白开来喝的？！传说一点都不靠谱啊。");
        this.addDescription(NMIDrinkItems.MAKAI_COFFEE, "After adding hot coffee to Makai spirit and stirring till well-mixed, the drink is topped with a dollop of fine cream, offering layered texture of milk, wine and coffee. Not only does it have a mellow taste, it also takes the chill off the body.", "在魔界的烈酒里加入热咖啡,搅拌到融化后,再在顶部盖上一团细腻的奶油,由奶香到酒香再到咖啡香层次分明,口感醇厚,还能驱除一身的寒意。");
        this.addDescription(NMIDrinkItems.DRUNKEN_BARD, "Alcohol brewed with peach blossoms. There's a rumor amongst the fairies that if you drink a cup of peach blossom wine and fall asleep in the flowers, you'll encounter a saint of peach blossoms. Though, I'm pretty sure that's just them being drunk.", "桃花酿的酒。妖精之间有着饮一壶桃花酒,醉卧花间,就会遇到桃花仙的传说。这怎么看都是喝醉了吧?");
        this.addDescription(NMIDrinkItems.FAIRY_DEW, "Fairies often gather dew to create a sweet drink mixed with honey. Since they often forget the product of their labor, it's often taken by animals or humans. Legend says that is has the ability to cure all diseases and even bring back to the dead, but those claims are unfounded.", "妖精们采集露水、和花蜜混合的甘甜饮料。由于妖精们会忘记自己的劳动产品，所以常被动物或者人类采走。传说可以治愈百病甚至起死回生，但似乎是谣言。");
        this.addDescription(NMIDrinkItems.FIRE_RATS_ROBE, "A super spicy shochu that can burn your mouth off if it hadn't been served in the Fire Robe. Almost no one can handle its spiciness.", "如果不使用火鼠裘来承装也许就会烧起来的烈酒，几乎无人能承受其辣度的超级辣口烈酒。");
        this.addDescription(NMIDrinkItems.FULL_MOONS_EVE, "Perhaps the anticipation of seeing the full moon during the eve is a stronger feeling than viewing it? This premium sake captured this sensation perfectly. A worthy drink for the moon in the Bamboo Forest of the Lost.", "比起十五夜的月亮是满月，也许更想留下十四夜时期待的心情。以这样的感觉酿造的高级清酒，也许只有它才配得上迷途竹林所见到的月亮吧。");
        this.addDescription(NMIDrinkItems.FRUITY_HIGHBALL, "A simple blend of whiskey, juice, and soda, all commonly available in izakayas. Now everyone can enjoy this drink thanks to the reduced alcohol content.", "居酒屋常见的，使用威士忌和果汁，苏打勾兑的简单调酒，降低了酒精度之后成为了谁都可以享受的饮料。");
        ...
        this.addDescription(NMIDrinkItems.DIVINE_WHEAT, "This shochu is made from barley blessed by the Goddesses of Autumn at the Youkai Mountain.", "使用妖怪之山上被秋天的神明们所庇佑的大麦所酿造的大麦烧酒。");
        ...
        this.addDescription(NMIDrinkItems.JADE_DEW_TEA, "Almost the best Japanese tea. It needs to be brewed at a lower water temperature, and offers a sweet and fragrant flavor with a distinct taste.", "几乎是日本茶中最高级的茶叶，需要用较低的水温来冲泡，甘醇飘香，口感独特。");
        this.addDescription(NMIDrinkItems.THIS_SIDE_UP, "Alcohol brewed by Seija Kijin herself, with alcohol content so high it's said to even make an oni drunk. It doesn't have a market in the village, and its not the cheapest drink, so she has to rely on her underlings using scare tactics to sell it.", "鬼人正邪亲自酿造的酒精浓度超级高、据说连鬼都能醉倒的无牌酒。在村子没有销路,价格还不便宜,只能靠手下以半吓半卖的方式销售出去。");
        this.addDescription(NMIDrinkItems.ICEBERG_KEDAMA_LEMONADE, "Melt the Cubic Kedama into a delicious smoothie and add frozen lemonade. There is no telling how many lives it has saved during the hot summer months. Customers who have visited MC Gensokyo say a trip is pointless without trying it.", "仿佛是融化在可口的冰沙中的毛玉，佐以冻柠口味，在炎热的夏季，不知拯救了多少人命，去MC幻想乡旅游过的客人这样评价:没喝过冰山毛玉冻柠，MC幻想乡等于白去。");
        ...
        this.addDescription(NMIDrinkItems.DASSAI, "One of the treasures of the Kiketsu Family. It randomly god this name because Otter Spirits placed enemy loot on the floor, resembling a ritual. It's actually a high-quality sake.", "鬼杰组的战利品之一，因为水獭灵把敌组的战利品摆在地上的样子仿佛祭典，于是随便取的名字。实际上好像是相当高级的纯米大吟酿。");
        this.addDescription(NMIDrinkItems.ICE_CREAM_SMOOTHIE, "Ice cubes from the kappa's ice bunker are crushed together with milk, sugar, and other ingredients in an iron bucket and stirred quickly. The resulting product is ice cream. The Outside World no longer uses this traditional method, but it is still commonly used in Gensokyo.", "河童们窖藏的天然冰块，和牛乳、糖等配料一起在铁桶里打碎，加速搅拌得到的产物，是古法制造的冰激凌。虽然现世已经不再用这种传统方法制作，但在幻想乡作为特色依旧很受欢迎。");
        this.addDescription(NMIDrinkItems.UMESHU, "Home-brew plum wine from the Human Village. The sweetness hides the alcohol content, and amateurs often pass out without even realizing it.", "人间之里的人类自酿的梅子酒，因为喝起来很甜，所以经常有不了解的生物被它的后劲儿击倒。");
        this.addDescription(NMIDrinkItems.MIO, "Fizzy sake with extra bubbles! It's sweet and sour and has a low alcohol content, making it very popular among girls. Can be considered a champagne variant of sake.", "在加入了大量的苏打后，这种起泡清酒酸甜的口感，以及较低的酒精度，使其很受女性的欢迎；可以说是清酒的香槟版本。");
        this.addDescription(NMIDrinkItems.RIBOVITAN, "A knock-off of some energy-boosting drink from the Outside World the kappas are selling. Apparently anyone can make it if you take the main ingredients and change the name... Is this really okay though?", "河童贩卖的外面世界某种提神功能性饮料的山寨品，据说提取了主要成分、换个名字谁都可以制作......但这样真的没问题吗？");
        ...
        this.addDescription(NMIDrinkItems.GRAPEFRUIT_JUICE, "Supposedly a popular drink from the Outside World. Extracted from red grapefruit, it is cool and refreshing, leaving a sweet aftertaste. Perfect for hot summer nights.", "据说是来自外界的人气饮料，用红色柚子这种水果榨汁，尤其是盛夏饮用，健康祛暑，让人回甘无穷。");
        this.addDescription(NMIDrinkItems.SCARLET_MIST, "A signature red wine from Sakuya. Expressive, and always has a faint mist around it. Seems to be produced under an unusual time flow.", "洋馆的女仆特制的红葡萄酒，酒体丰满，因为好像不是正常的时间下酿造出来的，总有一种雾气般的朦胧感。");
        this.addDescription(NMIDrinkItems.SATELLITE_ICE_COFFEE, "Momentarily exposing coffee to a vacuum, it boils instantly from the excessively low air pressure, and the water that is constantly bringing out from the vaporization phenomenon will eventually solidify. This simultaneously boiling and freezing coffee is a Lunarian Capital specialty drink.", "咖啡被瞬间暴露于真空中,会因为过低的气压导致瞬间涕腾,因汽化现象而被不断带走热量的水最终会在沸腾的过程中凝固。这种一边沸腾一边冰冻的咖啡是月都的特色饮料。");
        this.addDescription(NMIDrinkItems.BLOODY_REMY, "A blend of vodka, tomato juice, lemon slices, and celery root. The drink consists of a combination of sweet, sour, bitter, and spicy flavors. It is so named because its scarlet-colored liquid reminds people of the Scarlet Devil and her mansion.", "由伏特加、番茄汁、柠檬片、芹菜根混合调制，甜、酸、苦、辣四味俱全。因血红的颜色让人联想到某洋馆的吸血鬼，故得此名。");
        this.addDescription(NMIDrinkItems.SCARLET_TEA, "The drink has a unique aroma thanks to lemon, bergamot, and a variety of black tea carefully selected by Sakuya. Named after the majestic Scarlet Devil Mansion.", "使用柠檬，佛手柑，和女仆长精心挑选的红茶品种烘焙出带有独特香味的红茶饮料，为了扩张红魔馆的威严，非常普通地以红魔馆命名。");
        this.addDescription(NMIDrinkItems.RAMUNE, "A drink with a magical marble. Push the marble into the drink, and it'll cause the drink to violently carbonate. Drink up all the fizzing cold bubbles in one go and you'll feel the entire summer in your stomach.", "瓶口有弹珠的设计，只要向下按压将弹珠打入汽水内，引起二氧化碳的剧烈反应。此时将瓶中沸腾又冰冷的气泡一饮而尽的话，你会在胃中感受到整个夏天。");
        ...
        this.addDescription(NMIDrinkItems.SANGETSUSEI, "With the blessing of the Three Fairies, this sake has become a popular choice at izakayas: mid-alcohol, smooth taste, and affordable price. No wonder why.", "纯米酒，有着妖精的祝福。度数不高，口感柔顺，价格平易近人，是居酒屋受欢迎的选择。");
        this.addDescription(NMIDrinkItems.TENGU_TANGO, "A tengu would dance happily after drinking this delicious sake. I'll debunk this myth if I could open my izakaya at Youkai Mountain even once. Unlike other clear sake, this one has a light amber color.", "传说连天狗喝了也会开心地跳舞的美味清酒，在妖怪之山开一次店就可以验证了吧。不同于其他无色的清酒，带有淡淡的琥珀色。");
        this.addDescription(NMIDrinkItems.CASSIA_WINE, "Brewed in the winter, according to the custom of an ancient country. It's golden sweet, refreshing, and has an olive fragrance. It's delicious whether it's hot or cold.", "来自某个古国的习俗，在冬至日酿造的酒，色泽金黄，清甜甘冽，加上桂花的香气，无论冰着喝还是热着喝都非常可口。");
        ...
        this.addDescription(NMIFoodItems.CAUTION_HELLISH_SPICE, "The spiciest of spicy beef curries! They say only a fool or someone with extremely high tolerance would try this dish!", "超超超级辣加倍的牛肉咖喱饭!据说只有拥有极限忍时力的人和傻瓜才会尝试这道料理!");
        ...
        this.addDescription(NMIFoodItems.AGAINST_THE_WORLD, "Molecular gastronomy recipe made with revolutionary technology; said to have originated from the moon. Many unknowns were encountered during the cooking process, therefore a certain amount of redesigning had to be done. It ultimately became an \"earthly\" dish, fusing what is perceived to be \"elegant\" and \"conventional\", as well as an embodiment of Seija's wish to mush up the world.", "使用革新技术制作的分子料理,据说是来自月都的食谱。在制作过程中存在许多无法理解之处,所以经过一定程度的再创作,最终成为这样一个结合了世人眼中的“雅”与“俗”之物的地上料理,也寄托着正邪想要搅混天下的意愿。");
