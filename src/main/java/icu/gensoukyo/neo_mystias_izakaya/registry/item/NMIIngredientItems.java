...
public class NMIIngredientItems {
    ...
    public static final DeferredItem<Item> BAMBOO_SHOOT = registerItem(ITEMS, "ingredient/bamboo_shoot", Item::new, props -> props);
    public static final DeferredItem<Item> BINGDI_LOTUS = registerItem(ITEMS, "ingredient/bingdi_lotus", Item::new, props -> props);
    public static final DeferredItem<Item> BLACK_SALT = registerItem(ITEMS, "ingredient/black_salt", Item::new, props -> props);
    public static final DeferredItem<Item> BOAR_MEAT = registerItem(ITEMS, "ingredient/boar_meat", Item::new, props -> props);
    ...
    public static final DeferredItem<Item> CICADA_SLOUGH = registerItem(ITEMS, "ingredient/cicada_slough", Item::new, props -> props);
    ...
    public static final DeferredItem<Item> CREEPING_FIG = registerItem(ITEMS, "ingredient/creeping_fig", Item::new, props -> props);
    ...
    public static final DeferredItem<Item> FLOWER = registerItem(ITEMS, "ingredient/flower", Item::new, props -> props);
    public static final DeferredItem<Item> GINKGO_NUT = registerItem(ITEMS, "ingredient/ginkgo_nut", Item::new, props -> props);
    public static final DeferredItem<Item> GRAPES = registerItem(ITEMS, "ingredient/grapes", Item::new, props -> props);
    public static final DeferredItem<Item> IBERICO_PORK = registerItem(ITEMS, "ingredient/iberico_pork", Item::new, props -> props);
    public static final DeferredItem<Item> JIGURU_BERRY = registerItem(ITEMS, "ingredient/jiguru_berry", Item::new, props -> props);
    public static final DeferredItem<Item> LAMPREY = registerItem(ITEMS, "ingredient/lamprey", Item::new, props -> props);
    public static final DeferredItem<Item> LEMON = registerItem(ITEMS, "ingredient/lemon", Item::new, props -> props);
    public static final DeferredItem<Item> LOTUS_SEED = registerItem(ITEMS, "ingredient/lotus_seed", Item::new, props -> props);
    public static final DeferredItem<Item> LUNAR_HERB = registerItem(ITEMS, "ingredient/lunar_herb", Item::new, props -> props);
    ...
    public static final DeferredItem<Item> PREMIUM_TUNA = registerItem(ITEMS, "ingredient/premium_tuna", Item::new, props -> props);
    public static final DeferredItem<Item> RADISH = registerItem(ITEMS, "ingredient/radish", Item::new, props -> props);
    public static final DeferredItem<Item> RED_BEAN = registerItem(ITEMS, "ingredient/red_bean", Item::new, props -> props);
    public static final DeferredItem<Item> RED_TOON = registerItem(ITEMS, "ingredient/red_toon", Item::new, props -> props);
    ...
    public static final DeferredItem<Item> SNOW_FUNGUS = registerItem(ITEMS, "ingredient/snow_fungus", Item::new, props -> props);
    public static final DeferredItem<Item> STICKY_RICE = registerItem(ITEMS, "ingredient/sticky_rice", Item::new, props -> props);
    public static final DeferredItem<Item> STRONG_CAPSAICIN = registerItem(ITEMS, "ingredient/strong_capsaicin", Item::new, props -> props);
