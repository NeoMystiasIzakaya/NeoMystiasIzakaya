...
public class ModifyNMICustomerJsonsEvent extends Event {
    private final RegistryOps.RegistryInfoLookup registryInfoLookup;
    @Getter
    private final RegistryOps<JsonElement> ops;
    @Getter
    private final Map<Identifier, JsonElement> jsons;
    private final boolean isRareCustomer;

    public boolean isRareCustomer() {
        return isRareCustomer;
    }
    ...
    public ModifyNMICustomerJsonsEvent(final RegistryOps<JsonElement> ops, final Map<Identifier, JsonElement> jsons, boolean isRareCustomer) {
        this.registryInfoLookup = ops.lookupProvider;
        this.ops = ops;
        this.jsons = jsons;
        this.isRareCustomer = isRareCustomer;
    }
