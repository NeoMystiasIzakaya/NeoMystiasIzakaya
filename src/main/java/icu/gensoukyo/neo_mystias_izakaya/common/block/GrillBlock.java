...
import icu.gensoukyo.neo_mystias_izakaya.common.blockentity.GrillBE;
...
public class GrillBlock extends AbstractKitchenware {
    ...
    public GrillBlock(Properties properties) {
        super(properties
                .setId(ResourceKey.create(Registries.BLOCK, NeoMystiasIzakaya.id("grill")))
                .noOcclusion()
                .destroyTime(3.0F)
    ...
    public @Nullable BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new GrillBE(blockPos, blockState);
    }
